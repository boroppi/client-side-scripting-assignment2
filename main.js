...
createNewItemButton.addEventListener("click", function(event) {
  ...
  if (validateDate(dueDate.value) == false) {
    console.log("false");
    return false;
  }
  ...
  const deleteButton = newItemRow.querySelector(".item-delete");
  ...
  const editButton = newItemRow.querySelector(".item-edit");
...
function removeItem(event) {
  ...
  // passed selector.
  if (confirm("The row is going to be deleted.") == true) {
...
button.innerHTML = "Show the create new item form";
button.classList.add("btn");
button.classList.add("btn-primary");
button.id = "toggleFormButton";
const container = document.querySelector(".container");

container.insertBefore(button, newItemForm);

button.addEventListener("click", function() {
  if (newItemForm.style.display == "none") {
    button.innerHTML = "Hide the create new item form";
...
function validateDate(date) {
  if (date == "") {
    alert("Date is empty or invalid date");
    return false;
  }
}
